...
struct InstructionsView: View {
    ...
    var instructionText: String? {
        if let variant = variantManager.variant, variant == 1 {
            return "In this experiment, you will automatically receive notifications to reflect whenever a monitoring session is running. Feel free to accept or deny these notifications as you see fit, and remember that you will need to log at least 5 monitoring sessions of at least 5 hours each to complete the experiment. You can begin a reflection session manually by pressing the leaf icon in the upper-left corner of the Cue app on your Apple Watch. You must complete at least one reflection session during the experiment."
        } else if let variant = variantManager.variant, variant == 2 {
            return "In this experiment, you will receive a reminder to reflect at a set time every day. You can adjust this time by clicking the gear icon in the bottom-right corner of the Cue app on your Apple Watch. Feel free to accept or deny these reminders as you see fit, and remember that you will need to log at least 5 monitoring sessions of at least 5 hours each to complete the experiment. You can also begin a reflection session manually by pressing the leaf icon in the upper-left corner of the app. You must complete at least one reflection session during the experiment."
        } else if let variant = variantManager.variant, variant == 3 {
            return "During this experiment, you must complete at least one reflection session. To begin a reflection session, press the leaf icon in the upper-left corner of the Cue app on your Apple Watch. You are encouraged to begin a session whenever you are feeling stressed or anxious, and you may complete as many of these sessions as you wish. In addition to these reflective exercises, you will need to log at least 5 monitoring sessions of at least 5 hours each to complete the experiment."
        } else {
            return nil
        }
    }
