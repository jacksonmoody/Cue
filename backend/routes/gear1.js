...
router.post("/", async function (req, res) {
  try {
    ...
    var upcomingEvents = await getUpcomingEvents(googleTokens);
...
async function llmCall(userContext) {
  ...
  const schema = z.object({
    stressSources: z.array(z.object({
      title: z.string(),
      symbol: z.string(),
    })),
  });
  ...
  return response.parsed_output.stressSources;
}
